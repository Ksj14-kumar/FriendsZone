...
function FriendsCard({ info, sendFriendRequest, loader }) {
    ...
    return (
        <>
            ...
            <div className="conta  bg-[#fffcfc] flex justify-around align-baseline content-center w-[30rem] mds-editor21:w-full py-4 rounded-lg mb-[2rem] ">
                ...
                <section className="center  flex align-middle content-center truncate">
                    <p className='text-[1.8rem] mds-editor7:text-[1.4rem] mt-5 mds-editor7:mt-1'>{info.fname + " " + info.lname}</p>
                </section>
                ...
                <section className="right_side ">
                    <Button
                        ...
                        iconOnly={false}
                        ripple="light"
                        className="capitalize mt-[1.5rem] text-[1rem] tracking-wider mds-editor7:text-[.8rem] mds-editor7:mt-[.5rem]"
                        onClick={() => {
